...
=======
    ...
    print(f"Number of examples: {len(liar)}")

    print("------------------------------------")

    print("PREPROCESS DATA")

    kaggle = Dataset.from_pandas(kaggle).train_test_split(test_size=0.3, seed=42).class_encode_column("label")

    tokenized = kaggle.map(preprocess_function, batched=True)
    ...
    training_args = TrainingArguments(
        output_dir="results/bert-base-uncased/kaggle",
