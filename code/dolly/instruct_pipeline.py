...
# Mayla Kersten
#
# Code adapted from https://huggingface.co/databricks/dolly-v2-12b/blob/main/instruct_pipeline.py
#
...
INSTRUCTION_KEY = "### SECTION:"
RESPONSE_KEY = "### ARGUMENTATION:"
END_KEY = "### END"
INTRO_BLURB = ""
        ...
        for sequence in generated_sequence:
            ...
            if not decoded:
                ...
                if m:
                    ...
                    m = re.search(
                        r"#+\s*ARGUMENTATION:\s*(.+)", fully_decoded, flags=re.DOTALL
                    )
                    if m:
                        decoded = m.group(1).strip()
